%% @author mininm
%% @doc @todo Add description to fixerl_stop_timer.


-module(fixerl_stop_timer).
...
%% API functions
%% ====================================================================
-export([start_link/2, deactivate_timeout/1]).
...
%% ====================================================================
-record(state, {timeout, flag = false, id}).
-define(SERVER(Id), list_to_atom(lists:concat([?MODULE, "_", Id]))).
...
init([Timeout, Id]) ->
    ...
    {ok, #state{timeout = Timeout, id = Id}}.
